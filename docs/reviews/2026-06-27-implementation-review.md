...
> 🟡 **Em andamento — 2026-06-27.** ✅ **C1 (modelo de dados)**, ✅ **C2 (auth dev-first)**, ✅ **C3 (multilocal)** e ✅ **C4 (autorização/enforcement)** feitos e verificados. ⏳ Falta só **C5 (fluxos de entrada)**. Estratégia: Auth.js v5 + sessão **JWT** + tabela `users` própria; login dev por e-mail; Google/SMTP via env depois.
>
